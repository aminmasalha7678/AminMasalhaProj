...
import com.example.aminmasalhaproj.Admin.AddProductActivity;
import com.example.aminmasalhaproj.Admin.ShowProduct;
import com.example.aminmasalhaproj.TeamFragment;
import com.example.aminmasalhaproj.HomeFragment;
import com.example.aminmasalhaproj.SettingsFragment;
import com.example.aminmasalhaproj.PlayerFragment;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user != null) {
            ...
            username = header.findViewById(R.id.username_main);
            email = header.findViewById(R.id.email_main);
